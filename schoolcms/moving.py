...
time_re = re.compile(ur'([0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2})(?: \(最新編修時間 ([0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2})\))?')
...
with SessionGen() as sql_session:
    for post_url in post_urls:
        ...
        if movinglog:
            ...
            new_ann = Announce(title, content, author_group_name, author_name, False)
